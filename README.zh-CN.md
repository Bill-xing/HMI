...
| 内容 | 许可证 / 状态 |
| --- | --- |
| 焊缝分割数据集 | [CC BY 4.0](docs/licenses/dataset-cc-by-4.0.zh-CN.md) |
| 自训练 UNet 权重 | [Apache License 2.0](docs/licenses/model-weights-apache-2.0.zh-CN.md) |
| LeArm STL/结构模型 | 不随仓库提供，不授权二次分发 |
| 第三方参考项目 | 见 [THIRD_PARTY_NOTICES.zh-CN.md](THIRD_PARTY_NOTICES.zh-CN.md) |
| 仓库代码整体 | 当前不声明统一开源许可证 |
...
详见 [docs/reproduction/local-reproduction.zh-CN.md](docs/reproduction/local-reproduction.zh-CN.md)。
...
详见 [docs/reproduction/packaging.zh-CN.md](docs/reproduction/packaging.zh-CN.md)。
